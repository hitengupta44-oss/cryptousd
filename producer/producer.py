...
LOOKBACK = 60
PRED_MINUTES = 10
TRAIN_INTERVAL = 30 * 60  # retrain every 30 min
...
print("Producer started — Hybrid Institutional Model")
...
while True:
    try:
        ...
        elif time.time() - last_train_time > TRAIN_INTERVAL:
        ...
        for i in range(PRED_MINUTES):
            ...
            wick = max(body * 0.6, volatility * last_price * 0.4)
